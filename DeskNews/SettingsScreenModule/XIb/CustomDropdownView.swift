...
class CustomDropdownView: UIView, UITableViewDelegate, UITableViewDataSource {
    ...
    private func setupUI() {
        ...
        self.backgroundColor = colorManager().mainBgColor
        tableView = UITableView(frame: bounds, style: .plain)
        tableView?.delegate = self
        tableView?.dataSource = self
        tableView?.backgroundColor = colorManager().mainBgColor
        self.layer.borderColor = colorManager().tabBarTintColor.cgColor
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.textColor = colorManager().tabBarTintColor
